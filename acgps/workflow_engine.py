...
class WorkflowEngine:
    ...
    def trusted_project_audit_lineage_summary_verification(
        self,
        summary_path: Path,
    ) -> dict[str, Any]:
        ...
        current = self.trusted_project_audit_lineage_summary()
        ...
        final_current = self.trusted_project_audit_lineage_summary()
